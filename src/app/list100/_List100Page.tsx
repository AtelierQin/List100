...
import { useGoals, type Goal, generateId } from "@/lib/data";
...
export default function List100Page() {
    // No `!isMounted` guard: loaded via `next/dynamic({ ssr: false })` from page.tsx,
    // so localStorage is available immediately on first render.
